...
TYU=1
function START()
ST=gg.choice({'1. Radar ラフィ(Lobby)','2. Drone ラフィ(Lobby / Pick Hero)','3. Credit','4. Quit'}, nil, "The version you have is Raphiel Project Script v2.5betaiconradar")
...
-- Number Code
function ir()
gg.setRanges(bit32.bxor(gg.REGION_C_ALLOC, gg.REGION_C_HEAP, gg.REGION_C_DATA, gg.REGION_C_BSS))
gg.clearResults()
