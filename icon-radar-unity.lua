...
TYU=1
function START()
ST=gg.choice({'1. Radar ラフィ(Lobby & In Game)','2. Drone ラフィ(Lobby / Pick Hero)','3. Credit','4. Quit'}, nil, "The version you have is Raphiel Project Script v2.5betaiconradar")
